...
## Do not let the model cheat: cross-validation {.smaller}
...
## Do not let yourself cheat: prospective validation {.smaller}
...
For any retrospective experiment, you should always look for evidence that an analyst did not let the model cheat!
