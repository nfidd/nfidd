...
Build intuition for this session with the [**forecast ensembles** interactive](../interactive/forecast-ensembles.html){target="_blank"} — linear opinion pool vs quantile (Vincent) averaging. Part of the [interactive explainers](../reference/interactive-explainers.qmd) collection.
:::
