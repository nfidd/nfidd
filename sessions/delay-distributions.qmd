...
## Interactive: delay distributions

```{=html}
<iframe class="nfidd-embed" src="../interactive/delay-distributions.html?embed=discretise" title="delay distributions interactive" loading="lazy" style="width:100%;height:700px;border:1px solid #e5e7eb;border-radius:10px;background:#fff"></iframe>
...
Discretise a continuous delay into a daily PMF and watch censoring shift it. [Open the full explainer ↗](../interactive/delay-distributions.html){target="_blank"}
:::
...
```{=html}
<iframe class="nfidd-embed" src="../interactive/bayesian-updating.html?embed=update" title="Bayesian updating interactive" loading="lazy" style="width:100%;height:730px;border:1px solid #e5e7eb;border-radius:10px;background:#fff"></iframe>
<script>(function(){if(window.__nfiddEmbedInit)return;window.__nfiddEmbedInit=1;window.addEventListener('message',function(ev){var h=ev&&ev.data&&ev.data.nfiddEmbedHeight;if(!h)return;document.querySelectorAll('iframe.nfidd-embed').forEach(function(f){if(f.contentWindow===ev.source)f.style.height=(h+24)+'px';});});})();</script>
```

Posterior ∝ prior × likelihood — watch the posterior form as a compromise between prior and data, and the data take over as they accumulate. This is the inference we run with Stan here. [Open the full explainer ↗](../interactive/bayesian-updating.html){target="_blank"}
:::
