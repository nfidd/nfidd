...
::: {.callout-note collapse="true"}
## What happens when we use a forecast of statistical and mechanistic models? (optional)

In the above we have compared the mechanistic and statistical models. What happens if we use a forecast which is a combination of the two models? We can do this by combining the forecasts from the two models and then scoring the combined forecast.
