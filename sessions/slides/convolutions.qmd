...
::: {.fragment .fade-in}
- **however, a downside is that we won't have realistic uncertainty for small samples**
:::
...
Instead, we discretise the distribution (remembering that it is **double censored** - as both events are censored). One way of doing so:
...
::: {.fragment .fade-in}
- **Don't worry if this seems complicated we will explore this using simulation during the session**
:::
