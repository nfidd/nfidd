...
- **Joint approach**:  Shows the best overall performance with some overprediction bias and higher dispersion, indicating greater uncertainty.
- **Pipeline approach**: Slightly worse overall performance and has some systematic underprediction bias.
