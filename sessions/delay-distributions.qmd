...
Build intuition for this session with the [**delay distributions** interactive](../interactive/delay-distributions.html){target="_blank"} — discretise a continuous delay into a daily PMF and see the effect of censoring. Part of the [interactive explainers](../reference/interactive-explainers.qmd) collection.
:::
