...
$$ $$
R_0 \sim \mathcal{Lognormal}(1, 0.25)
$$ $$
...
We have also placed a prior on the initial reproduction number, which we have assumed to be normally distributed with a mean of 1 and a standard deviation of 0.25.
