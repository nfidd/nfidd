...
- we do not always have individual data available
...
::: {.fragment .fade-in}
- **however, a downside is that we will not have realistic uncertainty, especially if the number of individuals is small**
:::
...
Having moved to the population level, we cannot estimate individual-level event times any more.
