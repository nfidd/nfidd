...
Build intuition for this session with the [**nowcasting** interactive](../interactive/nowcasting.html){target="_blank"} — the right-edge dip, the reporting triangle, and the nowcast correction. Part of the [interactive explainers](../reference/interactive-explainers.qmd) collection.
:::
