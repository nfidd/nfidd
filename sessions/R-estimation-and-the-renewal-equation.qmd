...
## Interactive: the renewal equation

```{=html}
<iframe class="nfidd-embed" src="../interactive/renewal-equation.html?embed=mechanic,sim" title="the renewal equation interactive" loading="lazy" style="width:100%;height:750px;border:1px solid #e5e7eb;border-radius:10px;background:#fff"></iframe>
...
Drive an epidemic with R(t) and a generation interval; it turns over when R crosses 1. [Open the full explainer ↗](../interactive/renewal-equation.html){target="_blank"}
:::
...
Estimates near "today" are then poorly informed in two ways: the random walk for $R_t$ has very few downstream observations constraining its latest steps, and the convolution with the incubation period means the symptom onsets caused by very recent infections haven't been observed yet.
