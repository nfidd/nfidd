...
In those cases, the mean is impacted more, since that single outlying forecast pulls the mean down.
However, median remains close to the three other models that have close agreement, at least for the first few horizons.
:::
