...
However, unlike the infection to symptoms case here we do not assume that the two time series have the same magnitude so need to introduce a scaling.
...
Let us assume we have $I_0$ infections at time 0, and the scaling does not change in time.
