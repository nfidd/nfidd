...
## Interactive: biases in delay distributions

```{=html}
<iframe class="nfidd-embed" src="../interactive/biases-in-delay-distributions.html?embed=truncation" title="biases in delay distributions interactive" loading="lazy" style="width:100%;height:1050px;border:1px solid #e5e7eb;border-radius:10px;background:#fff"></iframe>
