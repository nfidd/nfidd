...
```{=html}
<iframe class="nfidd-embed" src="../interactive/forecasting-concepts.html?embed=fan" title="forecasting concepts interactive" loading="lazy" style="width:100%;height:1000px;border:1px solid #e5e7eb;border-radius:10px;background:#fff"></iframe>
