...
- The lognormal Stan model uses weakly informative `normal(0, 10)` priors. With this much data they barely affect the estimates. You can check this yourself by copying the model, changing its priors, and refitting.
