...
A calibration check that pairs with the PIT histogram: does a 90% prediction interval actually contain the truth 90% of the time? [Open the full explainer ↗](../interactive/forecast-evaluation.html){target="_blank"}
:::
...
See why the natural-scale score is dominated by the peak, while the log scale weights growth, peak and decline more evenly. [Open the full explainer ↗](../interactive/forecast-evaluation.html){target="_blank"}
:::
