...
```{=html}
<iframe class="nfidd-embed" src="../interactive/convolutions.html?embed=builder,sum" title="convolutions interactive" loading="lazy" style="width:100%;height:750px;border:1px solid #e5e7eb;border-radius:10px;background:#fff"></iframe>
...
Slide, multiply and sum latent infections into observed onsets. [Open the full explainer ↗](../interactive/convolutions.html){target="_blank"}
:::
