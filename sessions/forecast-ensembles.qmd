...
The LOP ensemble tends to be a bit wider than the `other ensemble forecasts`median_ensemble_filtered` forecast, especially at times when the individual component forecasts disagree more.
:::
