...
Interactive visualisations are embedded at the **CRPS** and **PIT histogram** definitions below — expand the dropdowns to explore them. They are also collected on the [interactive explainers](../reference/interactive-explainers.qmd) page.
:::
...
```{=html}
<iframe class="nfidd-embed" src="../interactive/forecast-evaluation.html?embed=crps" title="CRPS interactive" loading="lazy" style="width:100%;height:1200px;border:1px solid #e5e7eb;border-radius:10px;background:#fff"></iframe>
...
Drag the observation and the forecast spread to watch the CRPS area — and its dispersion / over-prediction / under-prediction breakdown. [Open the full explainer ↗](../interactive/forecast-evaluation.html){target="_blank"}
:::
...
```{=html}
<iframe class="nfidd-embed" src="../interactive/forecast-evaluation.html?embed=pit" title="PIT histogram interactive" loading="lazy" style="width:100%;height:1500px;border:1px solid #e5e7eb;border-radius:10px;background:#fff"></iframe>
<script>(function(){if(window.__nfiddEmbedInit)return;window.__nfiddEmbedInit=1;window.addEventListener('message',function(ev){var h=ev&&ev.data&&ev.data.nfiddEmbedHeight;if(!h)return;document.querySelectorAll('iframe.nfidd-embed').forEach(function(f){if(f.contentWindow===ev.source)f.style.height=(h+24)+'px';});});})();</script>
```

Build the histogram one forecast at a time — reading u = F(y) off each CDF — and see what U-shapes and domes are telling you. [Open the full explainer ↗](../interactive/forecast-evaluation.html){target="_blank"}
:::
