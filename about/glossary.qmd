...
**Renewal equation**: relates the number of infected people in the population; the current value of the reproduction number; and a delay distribution of the so-called generation time

**Random walk**: random noise along a given trajectory. In this course, we use a **geometric random walk**, where we add this random noise the logarithm of the reproduction number.
