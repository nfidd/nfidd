...
1. Estimate the delay distribution from external data
...
2. Understand the limitations of the data generating process
3. Perform a nowcast using a more realistic data generating process
4. Explore the impact of getting the delay distribution wrong
