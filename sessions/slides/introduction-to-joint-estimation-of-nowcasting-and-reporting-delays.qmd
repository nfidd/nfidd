...
## The limitations of simple nowcasting methods
  ...
  - Does not account for observation error in the primary events
...
3. **Apply delays to counts** (transform onset dates to report dates (like a convolution but we do not take the sum)))
