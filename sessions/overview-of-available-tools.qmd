...
It implements all the models discussed in the course with a frontend to work with snapshots of data by reference and reporting date.
Whilst this model can also be used for forecasts this does not currently have a user-facing interface in the package.
