...
To install the packages needed in the course, including the `nfidd` package that contains data files and helper functions used throughout, you can use the `remotes` package:

```{r install, eval = FALSE}
install.packages("remotes")
remotes::install_cran("nfidd", repos = c(
