...
## Interactive: the simplest nowcast

```{=html}
<iframe class="nfidd-embed" src="../interactive/nowcasting.html?embed=simple" title="the simplest nowcast interactive" loading="lazy" style="width:100%;height:720px;border:1px solid #e5e7eb;border-radius:10px;background:#fff"></iframe>
...
Spread each recent day's reports forward by the delay, cut them off at "now", and scale the observed part back up by the proportion reported.
:::
