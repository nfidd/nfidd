...
However, we often need to have some estimate for these delays when interpreting data in order to understand what is happening now and predict what might happen in the future.
