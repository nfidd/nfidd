...
Build intuition for this session with the [**forecasting concepts** interactive](../interactive/forecasting-concepts.html){target="_blank"} — extend a model into the future and watch the uncertainty fan grow with the horizon. Part of the [interactive explainers](../reference/interactive-explainers.qmd) collection.
:::
