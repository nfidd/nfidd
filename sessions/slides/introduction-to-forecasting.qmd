...
- Things that affect transmission do not affect the predicted outcomes directly, but via $R_t$
...
- Nowcast: we have **some** data from the dates we are predicting
- Forecast: we have **no** data from the dates we are predicting (usually: because they are in the future)
