...
A statistical term that can be used to describe a timeseries with a trend is saying that the time series is _non-stationary_.
More specifically, a _stationary_ time series is defined as one whose statistical properties, such as mean, variance do not change over time.
