...
- All of these model types have been used for COVID-19 forecasting (the US and/or European COVID-19 forecast hub)
...
- Models that do not include any epidemiological background e.g. ARIMA; also called *time-series models*
