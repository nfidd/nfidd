...
At the population level, individual-level delays translate into *convolutions*[^1].
...
You can view the function we have written to do this using:
...
[^1] An intuitive introduction (and much more) on convolutions is at [BetterExplained](https://betterexplained.com/articles/intuitive-convolution/).
