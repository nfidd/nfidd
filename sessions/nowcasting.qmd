...
::: {.callout-note collapse="true"}
## Solution
- The nowcast should look better than the previous one. The geometric random walk allows the model to capture the multiplicative growth in the data and so better capture the generative process of the data.
