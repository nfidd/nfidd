...
```{=html}
<iframe class="nfidd-embed" src="../interactive/nowcasting.html?embed=build,triangle" title="the reporting triangle filling in interactive" loading="lazy" style="width:100%;height:1250px;border:1px solid #e5e7eb;border-radius:10px;background:#fff"></iframe>
...
The reporting triangle and fill-in from the nowcasting session — here the delay itself must also be estimated from the same data. [Open the full explainer ↗](../interactive/nowcasting.html){target="_blank"}
:::
