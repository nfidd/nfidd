...
Build intuition for this session with the [**forecast evaluation** interactive](../interactive/forecast-evaluation.html){target="_blank"} — CRPS, the PIT histogram, DSS and WIS, with component breakdowns. Part of the [interactive explainers](../reference/interactive-explainers.qmd) collection.
:::
