...
To do this we can use a similar model to the one used in the [session on probability distributions](R-stan-and-statistical-concepts#estimating-the-parameters-of-probability-distributions), assuming (or knowing, in this instance) that the delays follows a lognormal distribution.
