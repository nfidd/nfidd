...
## Interactive: nowcasting

```{=html}
<iframe class="nfidd-embed" src="../interactive/nowcasting.html?embed=build" title="nowcasting interactive" loading="lazy" style="width:100%;height:1200px;border:1px solid #e5e7eb;border-radius:10px;background:#fff"></iframe>
...
See each day's cases split into observed + missing and summed into a nowcast, plus the reporting triangle.
:::
