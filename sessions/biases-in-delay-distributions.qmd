...
## Interactive: double interval censoring

```{=html}
<iframe class="nfidd-embed" src="../interactive/delay-distributions.html?embed=montecarlo" title="double interval censoring interactive" loading="lazy" style="width:100%;height:740px;border:1px solid #e5e7eb;border-radius:10px;background:#fff"></iframe>
...
Sample a primary time within its interval, add a continuous delay, floor to the day, repeat — and watch the realised (double-censored) distribution build up next to the individuals. [Open the full explainer ↗](../interactive/delay-distributions.html){target="_blank"}
:::
...
::: {.callout-tip .optional collapse="true"}
## Interactive: right truncation

```{=html}
<iframe class="nfidd-embed" src="../interactive/biases-in-delay-distributions.html?embed=truncation" title="right truncation interactive" loading="lazy" style="width:100%;height:800px;border:1px solid #e5e7eb;border-radius:10px;background:#fff"></iframe>
<script>(function(){if(window.__nfiddEmbedInit)return;window.__nfiddEmbedInit=1;window.addEventListener('message',function(ev){var h=ev&&ev.data&&ev.data.nfiddEmbedHeight;if(!h)return;document.querySelectorAll('iframe.nfidd-embed').forEach(function(f){if(f.contentWindow===ev.source)f.style.height=(h+24)+'px';});});})();</script>
```

Watch right truncation bias the observed delays short in real time. [Open the full explainer ↗](../interactive/biases-in-delay-distributions.html){target="_blank"}
:::
