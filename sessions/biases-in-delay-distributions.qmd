...
Sample a primary time within its interval, add a continuous delay, floor to the day, repeat — and watch the realised (double-censored) distribution build up next to the individuals.
:::
...
Watch right truncation bias the observed delays short in real time.
:::
