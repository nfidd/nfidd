...
Build intuition for this session with the [**biases in delay distributions** interactive](../interactive/biases-in-delay-distributions.html){target="_blank"} — see how right truncation biases observed delays short in real time. Part of the [interactive explainers](../reference/interactive-explainers.qmd) collection.
:::
