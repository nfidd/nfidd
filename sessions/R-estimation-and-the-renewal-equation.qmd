...
Build intuition for this session with the [**renewal equation** interactive](../interactive/renewal-equation.html){target="_blank"} — drive an epidemic with R(t) and a generation interval, and watch it turn when R crosses 1. Part of the [interactive explainers](../reference/interactive-explainers.qmd) collection.
:::
