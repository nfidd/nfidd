...
Build intuition for this session with the [**convolutions** interactive](../interactive/convolutions.html){target="_blank"} — slide, multiply and sum latent infections into observed onsets. Part of the [interactive explainers](../reference/interactive-explainers.qmd) collection.
:::
