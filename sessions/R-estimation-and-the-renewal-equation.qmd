...
```{=html}
<iframe class="nfidd-embed" src="../interactive/renewal-equation.html?embed=sim" title="the renewal equation interactive" loading="lazy" style="width:100%;height:750px;border:1px solid #e5e7eb;border-radius:10px;background:#fff"></iframe>
