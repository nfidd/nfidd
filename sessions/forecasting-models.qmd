...
We will now use the mechanistic and statistical models to forecast the number of cases in the future using a data simulated in the same way as we did in the [forecasting concepts session](forecasting-concepts). We will first load in the data and filter for a target forecast date.
...
- The stastical model forms notably worse at all forecast horizons.
