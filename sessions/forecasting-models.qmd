...
Build intuition for this session with the [**forecasting models** interactive](../interactive/forecasting-models.html){target="_blank"} — compare random-walk, statistical and mechanistic forecasts diverging across the horizon. Part of the [interactive explainers](../reference/interactive-explainers.qmd) collection.
:::
