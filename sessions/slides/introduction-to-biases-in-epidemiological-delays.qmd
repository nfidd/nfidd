...
::: {.callout-warning}
A common mistake is to only account for secondary event censoring while ignoring primary event censoring. This is often incorrect for epidemiological data.
:::
