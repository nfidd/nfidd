...
<<<<<<< HEAD:sessions/using-delay-distributions-to-model-the-data-generating-process-of-an-epidemic.qmd
...
>>>>>>> 7a766fc (remove locking into session order (#96)):sessions/04-using-delay-distributions-to-model-the-data-generating-process-of-an-epidemic.qmd
