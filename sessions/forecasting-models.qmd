...
$$ y_t = \phi_1 y_{t-1} + \phi_2 y_{t-2} + \sum_{k=1}^{3} \left[ \alpha_k \cos\left( \frac{2\pi k d(t)}{365} \right) + \beta_k \sin\left( \frac{2\pi k d(t)t}{365} \right) \right] + \varepsilon_t $$
where $\alpha_k$ and $\beta_k$ are the Fourier coefficients for the sine and cosine terms, and $d(t)$ is a representation of the day of the year from week t.
