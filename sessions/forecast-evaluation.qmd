...
One option is to evaluate a single point prediction against a single observation: error = point prediction - observation.
You may have seen these kinds of metrics: for example, mean absolute error, percentage error, root mean square error...
