...
- **Pipeline approach**: Shows the best overall performance but has some systematic underprediction bias.
- **Joint approach**: Slightly worse overall performancewith some overprediction bias and higher dispersion, indicating greater uncertainty.
