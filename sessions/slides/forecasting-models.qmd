...
![](https://oup.silverchair-cdn.com/oup/backfile/Content_public/Journal/biostatistics/14/3/10.1093_biostatistics_kxs052/1/kxs05202.gif?Expires=1722167238&Signature=jV-HNL5VRrTpanqfOydjV~RcZSNMvaS6ENMD6vGNuJUBR-aar7NImeJ44fkzLBm6HEJPVtH6N6VORbIDZk8au5dzM5~XEjrGSxkdMxYxLW2L4S8PGaNHhFEf0lEJH6WrvlsJat9eN8716ULDcNgbrNr7N4Kjah1erborOZODCbNyaL8e-2SChcSxMTU1Lf2s~OADpKzmADukH4PFv--rF4iShx4ppQwm~9~s-E3YAPBYaHpTISjl3oj7s97Z~ROFYLqBJ2PRQsyJXrDomXEtl5mwWPGzEt32kPRwNumZUJD0wN1M3GwadWZL1FB6CqBPu8qA5Vo365tiox58lr1Esg__&Key-Pair-Id=APKAIE5G5CRDK6RD3PGA)

[Dureau *et al.*, *Biostatistics*, 2013](https://doi.org/10.1093/biostatistics/kxs052)
...
- Models that don't include any epidemiological background e.g. ARIMA
- The random walk model we have used on its own (without going via $R_t$) is called a "stochastic volatility model"
...
# Plan for the this session

1. Review the performance of the random walk model from the last session
2. Motivate a mechanism to include in order to address some of the issues we identified
3. Motivate a statistical approach aiming to address the same issues without introducing epidemiological mechanism
4. Compare the performance of these models for a single forecast
5. Evaluate many forecast from these models and compare their performance to the random walk model
