...
We need to account for infections with longer delays that we have not yet observed. We can best do this by using a **lognormal distribution** for the delays that we do have data on.
