...
This can be found in the `inst/stan/functions` subdirectory or [viewed on the github repo](https://github.com/nfidd/nfidd/blob/main/inst/stan/functions/renewal.stan).
