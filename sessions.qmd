...
-   [Introduction](sessions/introduction-to-the-course-and-the-instructors.qmd): the course and the instructors (10 mins)
-   [Motivating the course](sessions/from-line-list-to-decisions.qmd): From an epidemiological line list to informing decisions in real-time (20 mins)
...
-   [Practice](sessions/delay-distributions.qmd): simulate and estimate epidemiological delays (30 mins)
-   Wrap up (5 mins)
