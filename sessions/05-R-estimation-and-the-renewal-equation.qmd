...
::: {.callout-tip}
## Take 10 minutes
Compare the results to ones from the model used earlier in this session, and the one used in the [previous session](04-using-delay-distributions-to-model-the-data-generating-process-of-an-epidemic).
