...
where $X$ and $X'$ are independent random variables sampled from the distribution $F$. To calculate this we simpley replace $X$ and $X'$ by samples from our posterior distribution and sum over all possible combinations.
