...
```{=html}
<iframe class="nfidd-embed" src="../interactive/forecast-ensembles.html?embed=headtohead" title="forecast ensembles interactive" loading="lazy" style="width:100%;height:1300px;border:1px solid #e5e7eb;border-radius:10px;background:#fff"></iframe>
...
Average probabilities (opinion pool) vs quantiles (Vincent) — and watch them diverge. [Open the full explainer ↗](../interactive/forecast-ensembles.html){target="_blank"}
:::
...
```{=html}
<iframe class="nfidd-embed" src="../interactive/forecast-evaluation.html?embed=wis" title="WIS interactive" loading="lazy" style="width:100%;height:1100px;border:1px solid #e5e7eb;border-radius:10px;background:#fff"></iframe>
<script>(function(){if(window.__nfiddEmbedInit)return;window.__nfiddEmbedInit=1;window.addEventListener('message',function(ev){var h=ev&&ev.data&&ev.data.nfiddEmbedHeight;if(!h)return;document.querySelectorAll('iframe.nfidd-embed').forEach(function(f){if(f.contentWindow===ev.source)f.style.height=(h+24)+'px';});});})();</script>
```

Add prediction intervals and watch the WIS converge to the CRPS, with the same dispersion / over / under split. [Open the full explainer ↗](../interactive/forecast-evaluation.html){target="_blank"}
:::
